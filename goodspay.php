...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO goodpayments (username, product, quantity, total_amount, payment_method)
            VALUES (?, ?, ?, ?, ?)";
    ...
    header(header: "Location: payment_gateway.php?user_id=$user_id&total_amount=$total_amount");
    exit();
}
